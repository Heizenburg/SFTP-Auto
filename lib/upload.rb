...
remote = {
  ...
  'ABV Brands' => '/euabvcs2ftp/Down/ABV Brands/Weekly/Shoprite',
  'Action Classics' => '/euactgh3ftp/Down',
  'Aerosol' => '/euascmw4ftp/Down',
  'African Extracts' => '/euafenr5ftp/Down',
  'AJ Products' => '/euajpcm6ftp/Down'
